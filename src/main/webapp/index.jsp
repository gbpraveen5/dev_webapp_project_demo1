...
<html>
<body>
 <h1>Maven project web_project!</h1>
<h2>Hello World!</h2>
 <h3>Maven is a build automation tool used primarily for Java projects. Maven can also be used to build and manage projects written in C#, Ruby, Scala, and other languages. The Maven project is hosted by the Apache Software Foundation, where it was formerly part of the Jakarta Project.
...
Alternative technologies like Gradle and sbt as build tools do not rely on XML, but keep the key concepts Maven introduced. With Apache Ivy, a dedicated dependency manager was developed as well that also supports Maven repositories.[</h3>
</body>
>>>>>>> 731b544f67e3e4c9b0a5d2baee1c59936ef01cc3
</html>
